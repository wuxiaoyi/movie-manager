CREATE TABLE `projects` (
  ...
  `company_id`              INT(11)       COMMENT '客户公司',
  `child_company_id`        INT(11)       COMMENT '客户公司二级',
...
--   `storyboard_id`           INT(11) COMMENT '分镜',
  `contract_amount`   DECIMAL(15, 2) DEFAULT 0 COMMENT '项目合同金额',
  `return_amount`     DECIMAL(15, 2) DEFAULT 0 COMMENT '项目回款金额',
  `real_cost`         DECIMAL(15, 2) DEFAULT 0 COMMENT '项目实际总成本',
  `budget_cost`       DECIMAL(15, 2) DEFAULT 0 COMMENT '项目预算总成本',
  `shooting_budget`   DECIMAL(15, 2) DEFAULT 0 COMMENT '项目拍摄预算',
  `late_state_budget` DECIMAL(15, 2) DEFAULT 0 COMMENT '项目后期预算',
  `shooting_cost`     DECIMAL(15, 2) DEFAULT 0 COMMENT '项目拍摄成本',
  `late_state_cost`   DECIMAL(15, 2) DEFAULT 0 COMMENT '项目后期成本',
